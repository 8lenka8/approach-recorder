...
class CreateWaypointDialogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonClimb.setOnClickListener {
            buttonClimb.isEnabled = false
            buttonWarning.isEnabled = true
            buttonLandmark.isEnabled = true
        }

        buttonWarning.setOnClickListener {
            buttonClimb.isEnabled = true
            buttonWarning.isEnabled = false
            buttonLandmark.isEnabled = true
        }

        buttonLandmark.setOnClickListener {
            buttonClimb.isEnabled = true
            buttonWarning.isEnabled = true
            buttonLandmark.isEnabled = false
        }
